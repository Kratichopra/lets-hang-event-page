    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-8 left-16 text-white/40">
          ...
          <div className="absolute top-2 left-1/3 text-white/40">
          ...
          <div className="absolute top-10 right-20 text-white/40">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="absolute bottom-2 right-6 text-white/50 italic bold text-xs font-medium">
            RSVP
          </div>
        </div>
